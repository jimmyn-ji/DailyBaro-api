...
public class DateUtil {
    ...
    /**
     * 获取当前时间前后minute分钟的时间，负数是前正数是后
     * @param date
     * @param minute
     * @return java.util.Date
     */
    public static Date getFiveMinAfter(Date date, Integer minute) throws ParseException {
     ...
     * @return java.util.Date
     */
    public static Integer diff(Date date) throws ParseException {
    ...
    public static Long[] checkDate(Date date1, Date date2) throws ParseException {
        ...
        Date date = df.parse(DateUtil.getDate(new Date(), DateUtil.DATETIME_FORMAT));
        System.out.println(DateUtil.getDate(new Date(), DateUtil.DATETIME_FORMAT));
